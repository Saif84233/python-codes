...
class Scoreboard:
	...
	def prep_high_score(self):
		...
		self.hight_score_image=self.font.render(high_score_str,True,self.txt_color,self.settings.bg_color)
	...
	def prep_level(self):
		...
		self.level_image=self.font.render(level_str,True,self.txt_color,self.settings.bg_color)
